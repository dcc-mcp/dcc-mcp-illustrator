...
def _acquire_adobepy_steps(request: InstallRequest, reason: str) -> list[dict[str, Any]]:
    ...
    script = (
        ...
        "'dcc-mcp\\adobepy\\0.8.0';"
        "$bundle=Join-Path $root 'adobepy-0.8.0-windows-x64';"
        ...
        "'https://github.com/dcc-mcp/adobepy/releases/download/adobepy-v0.8.0/"
        "adobepy-0.8.0-windows-x64.zip' -OutFile $archive;"
        "if((Get-FileHash -LiteralPath $archive -Algorithm SHA256).Hash.ToLowerInvariant()"
        "-ne 'b8633dbb093ee0b864057da4ded243aeb2359fead3a732d967304e3beb2da73e')"
        ...
        "-ne 'eaefea9d8a0921898157fba08cf5ae5a12108b17030c2c03f164450d03521ab1')"
